...
App = __decorate([
    ...
    __param(1, (0, inversify_1.inject)(types_1.TYPES.IUserCotroller)),
    __param(2, (0, inversify_1.inject)(types_1.TYPES.IExeptionFilter)),
    __param(3, (0, inversify_1.inject)(types_1.TYPES.ConfigService)),
    __param(4, (0, inversify_1.inject)(types_1.TYPES.PrismaService)),
    __metadata("design:paramtypes", [Object, users_contrller_1.UserCotroller, Object, Object, prisma_service_1.PrismaService])
], App);
exports.App = App;
